...
API_KEY = "iGmBU8ohAyWS6fHk34WZVDB2xFYfOP3y09AFaAwbnf87"
...
@app.route('/')
def index():#main page
	return render_template(r'C:\Users\rohith\Desktop\NALAIYA THIRAN\ONLY IN GIT\Final Deliverables\APPLICATION BUILDING\HTML\templates\car.html')

@app.route('/predict_page')
def predict_page():#predicting page
	return render_template(r'C:\Users\rohith\Desktop\NALAIYA THIRAN\ONLY IN GIT\Final Deliverables\APPLICATION BUILDING\HTML\templates\value.html')
...
def predict():
	...
	return render_template(r'C:\Users\rohith\Desktop\NALAIYA THIRAN\ONLY IN GIT\Final Deliverables\APPLICATION BUILDING\HTML\templates\predict.html',predict=predict)
